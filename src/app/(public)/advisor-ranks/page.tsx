  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-12">
      <div className="mb-8">
        <Link
          href="/mypage"
          className="text-sm text-stone-500 underline-offset-2 transition hover:text-stone-900 hover:underline"
        >
          ← マイページに戻る
        </Link>
      ...
      <div className="space-y-6">
        ...
        <div className="rounded-2xl border border-stone-200 bg-white p-6 shadow-md">
          <h2 className="text-base font-semibold text-stone-800">ランク一覧と条件</h2>
          <ul className="mt-4 space-y-3">
            {ADVISOR_RANK_CONDITIONS.map((r) => (
              <li key={r.label} className="flex items-start gap-3">
                ...
                <span className="text-sm text-stone-600">{r.condition}</span>
              </li>
            ))}
            <li className="flex items-start gap-3">
              <span className="mt-0.5 inline-flex shrink-0 items-center rounded-full bg-stone-100 px-2.5 py-0.5 text-xs font-medium text-stone-500">
                ランクなし
              </span>
              <span className="text-sm text-stone-600">上記の条件を満たしていない場合</span>
            </li>
          </ul>
        </div>
        ...
        {/* 集計の対象について */}
        <div className="rounded-2xl border border-stone-200 bg-white p-6 shadow-md">
          <h2 className="text-base font-semibold text-stone-800">集計の対象について</h2>
        ...
        {/* 注意事項 */}
        <div className="rounded-2xl border border-stone-200 bg-white p-6 shadow-md">
          <h2 className="text-base font-semibold text-stone-800">注意事項</h2>
          <ul className="mt-4 space-y-2 text-sm text-stone-600">
            <li className="flex gap-2">
              <span className="mt-0.5 shrink-0 text-stone-400">•</span>
